...
const Analytics = () => {
  ...
  const trendData = [
    { month: 'Jan', processed: 850, accuracy: 68.5 },
    { month: 'Feb', processed: 920, accuracy: 72.1 },
    { month: 'Mar', processed: 1050, accuracy: 78.3 },
    { month: 'Apr', processed: 1180, accuracy: 85.7 },
    { month: 'May', processed: 2847, accuracy: 94.9 },
  ];
        ...
        <div className="bg-white/50 dark:bg-gray-900/50 backdrop-blur-md border border-gray-200 dark:border-gray-800 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-md rounded-xl p-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">94.9%</p>
            </div>
            <div className="bg-gray-50/50 dark:bg-gray-800/50 backdrop-blur-md rounded-xl p-4">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">Avg File Size</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">32MB</p>
            </div>
          </div>
        </div>
      </div>
