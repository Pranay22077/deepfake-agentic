...
class ModelEvaluator:
    ...
    def test_api_connection(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                print(f"✅ API is running - Model loaded: {data.get('model_loaded', False)}")
                return True
            else:
    ...
    def run_evaluation(self):
        ...
        if not videos:
            print("❌ No test videos found. Check the path: test data/test data/raw/")
            return None
    ...
    def print_summary(self):
        ...
        if metrics['accuracy'] > 0.8:
            ...
            print("⚠️  FAIR: Model is better than random guessing")
        else:
...
def main():
    ...
    print("🧪 E-Raksha Model Evaluation")
    ...
    if results:
        ...
        print("❌ Evaluation failed. Check the setup and try again.")
