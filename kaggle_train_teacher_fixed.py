...
def find_data_directory():
    ...
    if possible_dirs:
        ...
        print(f"✅ Using: {best_dir[0]} ({best_dir[1]} images)")
        return best_dir[0]
    else:
...
if __name__ == "__main__":
    print("🚀 Starting Fixed Teacher Model Training")
    print("="*50)
    ...
    if model is not None:
        ...
        print(f"📈 History saved to: /kaggle/working/models/teacher_history.json")
